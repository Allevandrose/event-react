...
const Tickets = () => {
  ...
  if (loading) return <p className="text-center text-gray-500">Loading your tickets...</p>;
          ...
          {payments.map((payment) => (
            ...
            >
              <div className="bg-blue-100 p-4 rounded-t-lg">
                <h3 className="text-xl font-semibold text-blue-800">Event ID: {payment.event_id}</h3>
              </div>
              <div className="p-4">
                <p className="text-gray-700"><strong>Amount:</strong> ${payment.amount}</p>
                <p className="text-gray-700"><strong>Transaction:</strong> {payment.transaction_code}</p>
                
                {/* ✅ Download Ticket Button */}
                {payment.transaction_code ? (
                  <a
                    href={`/uploads/tickets/ticket-${payment.transaction_code}.pdf`}
                    target="_blank"
